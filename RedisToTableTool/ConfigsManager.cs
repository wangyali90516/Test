...
namespace UserToAssetTool
{
    public static class ConfigsManager
    {
        ...
        {
            return RedisConnectionMultiplexer.GetDatabase(Convert.ToInt32(ConfigurationManager.AppSettings["dbNumber"]), new object());
        }
        ...
        /// </summary>
        /// <returns>IDatabase.</returns>
        public static IDatabase GetBizRedisClientHelper(int number)
        {
            return RedisConnectionMultiplexer.GetDatabase(number, new object());
        }
